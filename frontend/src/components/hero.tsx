      ...
      <div className="w-full max-w-[1280px] mx-auto px-4 md:px-12 flex items-center relative z-10">
        ...
        >
          ...
          <div className="pt-4 sm:pt-5">
            <Link
              href="/rooms"
              className="inline-flex items-center justify-center bg-[#F5B01A] hover:bg-[#E09D0D] text-slate-900 text-[11px] sm:text-xs font-extrabold px-5 py-2 rounded-md shadow-md active:scale-95 transition-all cursor-pointer"
            >
              Find Rooms
            </Link>
          </div>
